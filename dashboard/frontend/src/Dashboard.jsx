...
const PAGES = { Performance: Home, Strategies, Assets, Network }
const PAGE_TABS = Object.keys(PAGES)

export default function Dashboard({ onToggleTheme }) {
  const [searchParams] = useSearchParams()
  const requestedTab = searchParams.get('tab')
  const activeTab = PAGE_TABS.includes(requestedTab) ? requestedTab : 'Performance'
  const isDark = useTheme()
  const c = th(isDark)
