...
const DARK = {
  ...
  b2: 'border-zinc-800',
  b3: 'border-zinc-700',
  navA: 'text-white border-b-2 border-current',
  navI: 'text-zinc-500 hover:text-zinc-200 border-b-2 border-transparent',
  togBg: 'bg-[#161616]',
...
const LIGHT = {
  ...
  b2: 'border-zinc-300',
  b3: 'border-zinc-400',
  navA: 'text-zinc-900 border-b-2 border-current',
  navI: 'text-zinc-500 hover:text-zinc-800 border-b-2 border-transparent',
  togBg: 'bg-zinc-100',
